    ...
    <template #main>
      <div class="relative">
        ...
        <section id="experience_page">
          <div
            class="pt-24 sticky top-0 h-screen bg-gradient-to-b from-gray-800 to-gray-600 text-white"
          >
        ...
        <section id="projects_page">
          <div class="pt-24 sticky top-0 h-screen bg-gradient-to-b from-gray-600 to-gray-800 text-white">
            <div class="flex justify-center">
