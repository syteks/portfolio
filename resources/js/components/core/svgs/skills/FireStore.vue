  ...
  >
    <defs>
      <path
        ...
        id="firestore-defs-path-1"
      />
      <filter x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox" id="firestore-defs-path-2">
      ...
      <path
        ...
        id="firestore-defs-path-3"
      />
      <filter x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox" id="firestore-defs-path-4">
    ...
    <path
      ...
      fill="#FFC24A"
    />
    <use fill="#FFA712" fill-rule="evenodd" xlink:href="#firestore-defs-path-1"/>
    <use filter="url(#firestore-defs-path-2)" xlink:href="#firestore-defs-path-1"/>
    <path
      d="M135.005 150.38l32.955-33.75-32.965-62.93c-3.129-5.957-11.866-5.975-14.962 0L102.42 87.287v2.86l32.584 60.233z"
      fill="#F4BD62"
    />
    <use fill="#FFA50E" fill-rule="evenodd" xlink:href="#firestore-defs-path-3"/>
    <use filter="url(#firestore-defs-path-4)" xlink:href="#firestore-defs-path-3"/>
