...
<template>
  ...
  >
    <linearGradient id="jira-grad-1">
      <stop offset=".18" stop-color="#0052cc"/>
      <stop offset="1" stop-color="#2684ff"/>
    </linearGradient>
    <linearGradient id="jira-grad-2" x1="98.031%" x2="58.888%" xlink:href="#a" y1=".161%" y2="40.766%"/>
    <linearGradient id="jira-grad-3" x1="100.665%" x2="55.402%" xlink:href="#a" y1=".455%" y2="44.727%"/>
    <path
