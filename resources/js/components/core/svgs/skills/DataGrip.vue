...
<template>
  <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="2500" height="2500">
    <defs>
      <linearGradient
        id="datagrip-grad-1"
        x1="75.15"
    ...
    <path fill="url(#datagrip-grad-1)" d="M119.8 19.8L74 0 35.6 32 91 60.6l28.8-40.8z"/>
    <path fill="url(#datagrip-grad-2)" d="M86.4 128L33 55.8 17 66.6 1.2 114.2 86.4 128z"/>
    <path fill="url(#datagrip-grad-3)" d="M96.6 91.6L59 67 0 59l86.4 69 10.2-36.4z"/>
    <path fill="url(#datagrip-grad-4)" d="M0 .8V59l111 38.2 8.8-77.4L0 .8z"/>
    <g>
